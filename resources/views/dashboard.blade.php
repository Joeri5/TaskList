                ...
                <table class="w-full text-md rounded mb-4">
                    ...
                    @if(sizeof(auth()->user()->tasks) == 0)
                        <tr class="border-b hover:bg-blue-100">
                            <td class="p-3 px-5 text-gray-700">
                                There where no tasks found
                            </td>
                        </tr>
                    @else
                            ...
                            <tr class="border-b hover:bg-blue-100">
                                ...
                                <td class="p-3 px-5">
                                    ...
                                    <a href="/task/{{$task->id}}" name="edit"
                                       class="mr-3 text-sm bg-gray-500 hover:bg-gray-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline">Edit</a>
